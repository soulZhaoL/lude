...
def load_test_data():
    ...
    try:
        ...
        return daily_returns['time_return'], '20220729', '20250328'
    except:
        # 创建模拟数据
        ...
        # 模拟每日收益率，均值0.0007（约合年化20%），标准差0.015
        daily_returns = pd.Series(np.random.normal(0.0007, 0.015, n_days))
...
if __name__ == "__main__":
    # 加载测试数据
    returns, start_date, end_date = load_test_data()
