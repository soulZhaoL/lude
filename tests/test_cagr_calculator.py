...
def calculate_bonds_cagr(df, start_date, end_date, hold_num, min_price, max_price,
    ...
    # 准备数据供 quantstats 使用
    # 创建带日期索引的收益率序列
    returns = pd.Series(res['daily_return'].values, index=res.index, name='return')
...
if __name__ == '__main__':
    ...
    factors = [
        {"name": "conv_prem", "description": "双低", "weight": 2, "ascending": False}, 
        {"name": "debt_to_assets", "description": "股息率", "weight": 1, "ascending": True}, 
        {"name": "list_days", "description": "5日涨跌幅", "weight": 2, "ascending": True}, 
        {"name": "option_value", "description": "5日成交量", "weight": 3, "ascending": True},
        {"name": "pct_chg_5_stk", "description": "5日成交量", "weight": 2, "ascending": True},
        {"name": "volatility_stk", "description": "5日成交量", "weight": 1, "ascending": True}
    ]
