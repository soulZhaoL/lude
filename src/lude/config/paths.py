...
HIGH_PERFORMANCE_FACTORS4_1_PATH = os.path.join(DATA_DIR, '100-130/fac4_1/merged_factors.json')
HIGH_PERFORMANCE_FACTORS4_2_PATH = os.path.join(DATA_DIR, '100-130/fac4_2/merged_factors.json')
HIGH_PERFORMANCE_FACTORS4_3_PATH = os.path.join(DATA_DIR, '100-130/fac4_3/merged_factors.json')
HIGH_PERFORMANCE_FACTORS4_4_PATH = os.path.join(DATA_DIR, '100-130/fac4_4/merged_factors.json')

HIGH_PERFORMANCE_FACTORS5_1_PATH = os.path.join(DATA_DIR, '100-130/fac5_1/merged_factors.json')
HIGH_PERFORMANCE_FACTORS5_2_PATH = os.path.join(DATA_DIR, '100-130/fac5_2/merged_factors.json')
HIGH_PERFORMANCE_FACTORS5_3_PATH = os.path.join(DATA_DIR, '100-130/fac5_3/merged_factors.json')
HIGH_PERFORMANCE_FACTORS5_4_PATH = os.path.join(DATA_DIR, '100-130/fac5_4/merged_factors.json')

HIGH_PERFORMANCE_FACTORS6_1_PATH = os.path.join(DATA_DIR, '100-130/fac6_1/merged_factors.json')
HIGH_PERFORMANCE_FACTORS6_2_PATH = os.path.join(DATA_DIR, '100-130/fac6_2/merged_factors.json')
HIGH_PERFORMANCE_FACTORS6_3_PATH = os.path.join(DATA_DIR, '100-130/fac6_3/merged_factors.json')
HIGH_PERFORMANCE_FACTORS6_4_PATH = os.path.join(DATA_DIR, '100-130/fac6_4/merged_factors.json')
