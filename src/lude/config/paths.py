...
HIGH_PERFORMANCE_FACTORS4_1_PATH = os.path.join(DATA_DIR, '100-200/fac4_1/merged_factors.json')
HIGH_PERFORMANCE_FACTORS4_2_PATH = os.path.join(DATA_DIR, '100-200/fac4_2/merged_factors.json')
HIGH_PERFORMANCE_FACTORS4_3_PATH = os.path.join(DATA_DIR, '100-200/fac4_3/merged_factors.json')
HIGH_PERFORMANCE_FACTORS4_4_PATH = os.path.join(DATA_DIR, '100-200/fac4_4/merged_factors.json')
