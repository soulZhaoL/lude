...
def cal_cagr(df, start_date, end_date, hold_num, min, max, rank_factors):
...
if __name__ == '__main__':
    ...
    max = 150
    factors = [
        {'name': 'conv_prem', 'weight': 1, 'ascending': False},
        {'name': 'turnover_5', 'weight': 2, 'ascending': True},
        {'name': 'debt_to_assets', 'weight': 1, 'ascending': True}
    ]
    cagr = cal_cagr(df, start_date, end_date, hold_num, min, max, factors)
    print(cagr)
