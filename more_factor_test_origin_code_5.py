...
if __name__ == '__main__':
    cagr = cal_cagr(df, start_date, end_date, None)
    print("年化收益率: ", cagr)
    # factors = ['pre_close', 'open', 'high', 'low', 'close', 'pct_chg', 'vol',
    #            'amount', 'volatility', 'code_stk', 'name_stk', 'pre_close_stk',
    #            'open_stk', 'high_stk', 'low_stk', 'close_stk', 'pct_chg_stk',
    #            'vol_stk', 'amount_stk', 'pe_ttm', 'pb', 'ps_ttm', 'dv_ratio',  # 30
    #            'total_share', 'float_share', 'total_mv', 'circ_mv', 'debt_to_assets',
    #            'volatility_stk', 'pct_chg_5', 'pct_chg_5_stk', 'bias_5', 'is_call',
    #            'conv_price', 'conv_value', 'conv_prem', 'dblow', 'issue_size',
    #            'remain_size', 'remain_cap', 'turnover', 'cap_mv_rate', 'list_date',
